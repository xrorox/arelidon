...
<!--  
	<input type="button" class="button" value="Cr�er un nouveau personnage" onclick="changeUrl(\'index.php?page=selectchar&amp;register=1\');" />
-->
...
<div id="select_char_container"> 
	<?php
		if(empty($_GET['register'])){
			...
			$charList =loadSqlResultArrayList($sql);
