...
echo '<div> Liste des magasins de comp&eacute;tence </div>';
echo '<div>';
 echo '<table border="1" class="backgroundBodyNoRadius" cellspacing="0" style="border:solid 1px black;text-align:center;width:800px;">';
	echo '<tr class="backgroundMenuNoRadius">';
		...
		{
			$urltri = "gestion/page.php?category=29&orderby=";
	...
	$arrayShop = shop_skill::getAllShop($min,$max,$order,$asc);
	...
	{		
		...
		foreach($arrayStatut as $row=>$trad)
		{
			...
			$urledit = "gestion/page.php?category=29&action=edit&id=$id";
...
echo '<div id="addShop" style="height:18px;float:left;">';
	$url = "gestion/page.php?category=29&action=add";
