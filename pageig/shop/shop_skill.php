...
if($_GET['action'] != "") require_once('require.php');
...
echo '<div>';
	...
	echo '<div style="float:left;width:560px;border-right:1px;margin-left:10px;">';
		...
		echo '<div id="shop_text_container">';
			switch($action)
			{
				case 'buy':
					...
					if($char->gold >= $price)
					{
						...
						if($learn == 1)
						{
							...
							$txt .= "<div> Vous poss�dez d�j� ce sort. </div>";
						}else{
				...
				default:
					$txt = ' <div id="shop_text">Bienvenue dans le magasin , pour acheter un objet , il vous suffit de cliquez dessus.</div>';
				break;
			}
	...
	echo '<div  style="float:left;margin-right:5px;margin-top:25px;">';
		...
		echo '<div id="skill_container" style="height:170px;">';
			...
			echo '<div style="font-weight:500;text-align:center;"> Votre bourse : '.$char->gold.' <img src="pictures/utils/or.gif" title="pi&egrave;ce d\'or" alt="or" /></div>';
			echo '<div></div>';
